...
namespace UI
{
	static void _DRAW_TOOLTIP_NOTIFICATION(Any p0, BOOL loop, BOOL beep, int shape) { invoke<Void>(0xB59B530D, p0, loop, beep, shape); } // 0x238FFE5C7B0498A6 0xB59B530D
	static void _SET_TEXT_COMPONENT_FORMAT(char* inputType) { invoke<Void>(0xB245FC10, inputType); } // 0x8509B634FBE7DA11 0xB245FC10
	...
	static int _0xDEB491C8(char* picName1, char* picName2, BOOL flash, int iconType1, char* sender, char* subject, float duration, char* clanTag, int iconType2) { return invoke<int>(0xDEB491C8, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2); } // 0xDEB491C8 0xDEB491C8
